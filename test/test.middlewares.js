          ...
          chai
            ...
            .end((err, res) => {
              ...
              expect(res.body).to.have.property(
                "message",
                "Error: Missing required param. Please ensure that the following params are provided in the query: alias, realEmail."
              );
              done();
            });
        });
      ...
      it("should be rejected with a message as to why", done => {
        chai
          ...
          .end((err, res) => {
            ...
            expect(res.body).to.have.property(
              "message",
              "Error: The supplied realEmail parameter is invalid."
            );
            done();
          });
      });
